...
public:
	...
	WorldObjectBase(const VECTOR& _position, const VECTOR& _rotation, const VECTOR& _scale, const bool& _isActive, const int& _hanlde) : position{ _position }, rotation{ _rotation }, scale{ _scale }, ObjectBase(_hanlde, _isActive, RenderLayer::World) {} // 位置と回転とスケールと生存フラグとハンドルを初期化
