...
void FrameRateCounter::Update(const std::chrono::time_point<std::chrono::steady_clock>& _currentTime)
{
	...
	auto elapsedTime{ std::chrono::duration_cast<std::chrono::microseconds>(_currentTime - startTime).count() };
